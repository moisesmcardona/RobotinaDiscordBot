...
Public Class Form1
    ...
    Private Async Function OnGuildMemberAdd(ByVal e As GuildMemberAddEventArgs) As Task Handles DiscordClient.GuildMemberAdded
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(338795922878234634), "Démosle una cordiál bienvenida a " & e.Member.Mention & " al chat de ProVenezuela" & Environment.NewLine & Environment.NewLine & "Atentantamente, " & Environment.NewLine & "-Robotina")
    End Function
    ...
    Private Async Function OnMessage(ByVal e As MessageCreateEventArgs) As Task Handles DiscordClient.MessageCreated
        ...
        If e.Message.Author.Username = "ProVenezuela" = False Then
            If e.Channel.Id = 338795922878234634 Then 'ProVenezuela
                ...
                ElseIf e.Message.Content.ToLower().Contains("!seguidores") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & FollowerNumber & " seguidores :heart:")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & FollowerNumber & " seguidores :heart:")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!siguiendo") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", sigues a " & FollowingNumber & " perfiles :heart:")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " sigue a " & FollowingNumber & " perfiles :heart:  ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!ubicación") Or e.Message.Content.ToLower.Contains("!ubicacion") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & " es de " & location & " :heart:")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " es de " & location & " :heart:")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!posts") Then
                    Dim postNumber As Integer = GetResultFromSteemPlaceAPI(User, "posts")
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & postNumber & " posts y comentarios combinados :heart:")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & postNumber & " posts y comentarios combinados :heart:")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!creacion") Or e.Message.Content.ToLower().Contains("!creación") Or e.Message.Content.ToLower().Contains("!registro") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tu cuenta fue creada el " & FullDate & " a las " & DateAndTime.ToString("hh:mm:ss tt") & " :heart: ")
                    Else
                        Await e.Channel.SendMessageAsync("La cuenta de @" & User & " fue creada el " & FullDate & " a las " & DateAndTime.ToString("hh:mm:ss tt") & " :heart: ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!sbd") Then
                    Dim Balance As String = GetResultFromSteemPlaceAPI(User, "sbd")
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & Balance & " :heart: ")
                    Else
                ...
                End If
            End If
            If e.Channel.Id = 410240985818464266 Then
            ...
            If e.Channel.Id = 339767929048399882 = False And e.Channel.Id = 390471607144939522 = False And e.Channel.Id = 339205126923354123 = False And e.Channel.Id = 390473677491273728 = False And e.Channel.Id = 407207720614232064 = False And e.Channel.Id = 426792608950648832 = False And e.Channel.Id = 426780066442117130 = False And e.Channel.Id = 427560632544526346 = False And e.Channel.Id = 407207720614232064 = False Then
                If e.Message.Content.Contains("steemit.com/") Or e.Message.Content.Contains("busy.org/") Or e.Message.Content.Contains("utopian.io/") Then
                    ...
                    If SplitWords.Count > 4 Then
                        Dim Channel As DiscordChannel = Await DiscordClient.GetChannelAsync(390471607144939522)
...
":police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: " & vbCrLf &
":warning: Por favor, escribe para confirmar que viste la advertencia :warning: Infracciones múltiples resultarán en tu expulsión de este servidor."
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(338795922878234634), Message)
    End Sub

    Private Async Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(338795922878234634), TextBox1.Text)
    End Sub
End Class
